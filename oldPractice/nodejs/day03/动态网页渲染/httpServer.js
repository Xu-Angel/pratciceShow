const http=require('http'),path=require('path'),fs=require('fs'),xtpl=require('xtpl'),
...
xtpl.renderFile(path.join(__dirname,'static',basename),{data},(error,content)=>{
if(error){console.log(reeor);return;}res.end(content);
});
